...
class CustomPostTypeController extends BaseController
{
    ...
    public function storeCustomPostTypes() {
		...
		$option = get_option('alecad_plugin_cpt');
		...
		foreach($option as $option) {
			...
			$this->custom_post_types[] =  array(
				...
				'attributes'            => $option['singular_name'] . ' Archives',
				...
				'not_found'             => $option['singular_name'] . ' Not Found',
				'not_found_in_trash'    => $option['singular_name'] . ' Not Found in Trash',
